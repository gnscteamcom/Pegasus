...
--
-- Máquina: localhost
-- Data de Criação: 04-Fev-2014 às 15:09
...
('Funcionário', 'Admin', '', 'teste@hss.com', 'Agora em novo endereço', '', '', '', '', '', '', 1),
...
('32eff1ebbe723978242222a32c62e758', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.107 Safari/537.36', 1391526475, 'a:2:{s:9:"user_data";s:0:"";s:9:"person_id";s:1:"1";}'),
('42bcaa8c8994de607f3c0d3427ac7a67', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.76 Safari/537.36', 1390439980, 'a:2:{s:9:"user_data";s:0:"";s:9:"person_id";s:1:"1";}'),
('a3cf04220d4e21d92f3488a2cd3c42f4', '0.0.0.0', 'Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/32.0.1700.76 Safari/537.36', 1390437078, 'a:8:{s:9:"person_id";s:1:"1";s:8:"cartRecv";a:0:{}s:9:"recv_mode";s:7:"receive";s:8:"supplier";i:-1;s:4:"cart";a:0:{}s:9:"sale_mode";s:4:"sale";s:8:"customer";i:-1;s:8:"payments";a:0:{}}');
...
--
-- Limitadores para a tabela `pos_item_kit_items`
--
...
--
-- Limitadores para a tabela `pos_permissions`
--
...
--
-- Limitadores para a tabela `pos_receivings`
--
...
--
-- Limitadores para a tabela `pos_receivings_items`
--
...
--
-- Limitadores para a tabela `pos_sales`
--
...
--
-- Limitadores para a tabela `pos_sales_items`
--
...
--
-- Limitadores para a tabela `pos_sales_items_taxes`
--
...
--
-- Limitadores para a tabela `pos_sales_suspended_items`
--
...
--
-- Limitadores para a tabela `pos_sales_suspended_items_taxes`
--
...
--
-- Limitadores para a tabela `pos_sales_suspended_payments`
--
...
--
-- Limitadores para a tabela `pos_suppliers`
--
