...
class Item extends PHPFrodo {
    ...
    public function novo() {
        ...
        if (isset($_SESSION['plano_limite']) == true && $limite >= $this->limite_produto) {
    ...
    public function incluir() {
        if ($this->postIsValid(array(
            ...
            $this->postValueChange('item_title', addslashes($this->postGetValue('item_title')));
            ...
            $desconto = $this->postGetValue('item_desconto');
            if ($desconto != "" && strlen($desconto) >= 1) {
                $this->postValueChange('item_desconto', preg_replace(array('/\./', '/\,/'), array('', '.'), $desconto));
            }
