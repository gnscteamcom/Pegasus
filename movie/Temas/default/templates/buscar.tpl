...
<div class="plt_tit bold fs14px mgbot10px"><span>Sinopsis</span> <h2 class="bold d_inline fs14px">{$m.p_titulo|escape}</h2></div> 
...
<br /><br />
<div class="stars f_left pdtop10px"><strong>Calidad</strong>: {$m.p_calidad|escape}</div>  
<br /><br />
<div class="stars f_left pdtop10px"><strong>Visualizada</strong>: {$m.p_hits} Veces</div> 
</div> 
</div> 
</div> 
</li> 
...
<!--</peliculas>--> 					
                    ...
                    <!--</nav>--> 
					{/if}
{else}<center>No se ha encontrado resultado a su búsqueda</center><br />{/if}
                </div> 
                <!--</bkcnpels>--> 
       		</div> 
            <!--</cn>--> 
